...
<!-- end of profile -->
			...
			<div class='leftContent'>
				<div<?=($leftlink == 'viewprojects' ? ' class="active"' : '')?>><a href='index.php'>View Projects</a></div>
			</div>
      	</td>
      	<td class='maincontent'>
			<table class="banner" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td class="icon"><?=(isset($banner_icon) && $banner_icon!="" ? '<img src="'.$BF.$banner_icon.'" alt="Icon" />' : "")?></td>
					<td class="main">
