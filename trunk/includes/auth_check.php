<?
	...
	if (isset($_POST['auth_form_name'])) {  // check to see if this is a submission of the login form
		...
		$q = "SELECT * FROM People WHERE !bDeleted AND chrEmail='" . $auth_form_name . "'";
	...
	# if the page requires they they be logged in, set this variable to false	
	...
	if ($auth_not_required != true) {  // if not authenticated, present the form
